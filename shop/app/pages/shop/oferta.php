...
<div class="modal-footer">
  <button class="btn btn-warning btn-ef btn-ef-4 btn-ef-4c" ng-click="mo.cancel()"><i class="fa fa-arrow-left"></i> Cancel</button>
  <button class="btn btn-success btn-ef btn-ef-3 btn-ef-3c" ng-disabled="formOf.$invalid || !mo.fData.isSel" ng-click="mo.aceptar()"><i class="fa fa-arrow-right"></i> Send </button>
</div>