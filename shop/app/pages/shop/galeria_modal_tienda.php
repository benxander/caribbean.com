...
<div class="modal-body">
    ...
    <div class="row" masonry>
        ...
        >
          <div class="masonry-brick col-md-3 m-20" ng-class="{'selected': image.selected}" ng-repeat="image in gm.images">
            <div class="img-container">
              <img class="img-responsive btn btn-rounded btn-ef btn-ef-2 btn-ef-2-danger btn-ef-2b" ng-src="{{image.src}}" alt="" ng-click="gm.selectFoto(image,$index)">
...
<div class="modal-footer">
  <button class="btn btn-warning btn-ef btn-ef-3 btn-ef-3c" ng-click="gm.aceptar()"><i class="fa fa-arrow-right"></i> Close</button>
</div>