(function() {
  ...
  /** @ngInject */
  function PagesGalleryController($scope,$uibModal, $state,$stateParams, PagesGalleryServices, rootServices, MensajeServices, TiendaServices, ClienteServices, pageLoading, Socialshare,toastr) {
    var vm = this;
